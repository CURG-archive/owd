...
(cl:defmethod cl:initialize-instance :after ((m <CalibrateJoints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalibrateJoints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<CalibrateJoints-request> is deprecated: use owd-srv:CalibrateJoints-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <CalibrateJoints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalibrateJoints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<CalibrateJoints-response> is deprecated: use owd-srv:CalibrateJoints-response instead.")))
