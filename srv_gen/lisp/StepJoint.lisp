...
(cl:defmethod cl:initialize-instance :after ((m <StepJoint-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepJoint-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<StepJoint-request> is deprecated: use owd-srv:StepJoint-request instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <StepJoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader owd-srv:joint-val is deprecated.  Use owd-srv:joint instead.")
  (joint m))

(cl:ensure-generic-function 'radians-val :lambda-list '(m))
(cl:defmethod radians-val ((m <StepJoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader owd-srv:radians-val is deprecated.  Use owd-srv:radians instead.")
  (radians m))
...
(cl:defmethod cl:initialize-instance :after ((m <StepJoint-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepJoint-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<StepJoint-response> is deprecated: use owd-srv:StepJoint-response instead.")))
