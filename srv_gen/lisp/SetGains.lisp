...
(cl:defmethod cl:initialize-instance :after ((m <SetGains-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGains-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<SetGains-request> is deprecated: use owd-srv:SetGains-request instead.")))
...
(cl:defmethod gains-val ((m <SetGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader owd-srv:gains-val is deprecated.  Use owd-srv:gains instead.")
  (gains m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetGains-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGains-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name owd-srv:<SetGains-response> is deprecated: use owd-srv:SetGains-response instead.")))
